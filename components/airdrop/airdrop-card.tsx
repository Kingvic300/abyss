...
export function AirdropCard({ airdrop, onClaimClick }: AirdropCardProps) {
  return (
    <div className="bg-black/40 border border-gray-700 rounded-lg p-4 sm:p-6 flex flex-col sm:flex-row gap-4 sm:gap-6 hover:bg-black/60 transition-colors backdrop-blur-sm overflow-hidden">
      {/* Content */}
