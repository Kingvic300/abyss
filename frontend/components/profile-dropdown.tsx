      ...
      <DropdownMenu onOpenChange={setIsOpen}>
        <div className="group relative">
          <DropdownMenuTrigger asChild>
            <button
              type="button"
              className="flex items-center gap-8 pl-2 rounded-2xl bg-white dark:bg-transparent border border-zinc-500/60 dark:border-zinc-800/60 hover:border-zinc-300/60 dark:hover:border-gray-400 hover:shadow-sm transition-all duration-200 focus:outline-none"
            >
