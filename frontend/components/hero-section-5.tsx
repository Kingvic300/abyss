      ...
      <main className="overflow-x-hidden">
        <section>
          <div className="py-24 md:pb-32 lg:pb-36">
            <div className="relative z-10 mx-auto flex max-w-6xl flex-col px-6 lg:block lg:px-12">
              <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl">
                  Web3 Onboarding, Made Effortless
                </h1>
                <p className="mt-8 max-w-2xl text-balance text-lg">
                  Send crypto assets or messages via a simple link. The receiver
                  needs no wallet, no gas fees, and no crypto knowledge, just
                  one click to claim.
                </p>
            ...
            <div className="absolute inset-1 overflow-hidden rounded-3xl border-2 border-black/10 h-screen lg:rounded-[3rem] dark:border-white/5">
              <img
                className="size-full object-cover"
                src="/sky-bg.png"
              />
              <div className="bg-gradient-to-r from-[#352939] absolute inset-y-0 left-0 w-1/2"></div>
              <ProgressiveBlur
        ...
        {/* <section className="bg-[#352939] pb-2">
          <div className="group relative m-auto max-w-7xl px-6">
            <div className="flex flex-col items-center md:flex-row">
              ...
              <div className="relative py-6 md:w-[calc(100%-11rem)]">
                ...
                <div className="bg-gradient-to-r from-[#352939] absolute inset-y-0 left-0 w-20"></div>
                <div className="bg-gradient-to-l from-[#352939] absolute inset-y-0 right-0 w-20"></div>
                <ProgressiveBlur
  ...
  return (
    <header>
      ...
      >
        <div
          className={cn(
            "mx-auto max-w-6xl rounded-3xl px-6 transition-all duration-300 lg:px-12",
